...
public class FichaL extends Ficha {
    ...
    Cadrado cadrado0 = new Cadrado(120, 0, Color.green);
    Cadrado cadrado1 = new Cadrado(120, 30, Color.green);
    Cadrado cadrado2 = new Cadrado(120, 60, Color.green);
    Cadrado cadrado3 = new Cadrado(150, 60, Color.green);
    Border borde;
    ...
    public FichaL() {
        ...
        for (int i = 0; i < cadrados.size(); i++) {
            ...
            cadrados.get(i).lblCadrado.setBackground(Color.green);
    ...
    public boolean rotar() {
        ...
        cadrados.get(3).lblCadrado.setLocation(cadrados.get(3).x = cadrados.get(3).x, cadrados.get(3).y = cadrados.get(3).y - 60);
        }else if(posicion==1){
        cadrados.get(0).lblCadrado.setLocation(cadrados.get(0).x = cadrados.get(0).x + 30, cadrados.get(0).y = cadrados.get(0).y + 30);
        cadrados.get(2).lblCadrado.setLocation(cadrados.get(2).x = cadrados.get(2).x - 30, cadrados.get(2).y = cadrados.get(2).y - 30);
        cadrados.get(3).lblCadrado.setLocation(cadrados.get(3).x = cadrados.get(3).x - 60, cadrados.get(3).y = cadrados.get(3).y );    
        }else if(posicion==2){
        cadrados.get(0).lblCadrado.setLocation(cadrados.get(0).x = cadrados.get(0).x + 30, cadrados.get(0).y = cadrados.get(0).y - 30);
        cadrados.get(2).lblCadrado.setLocation(cadrados.get(2).x = cadrados.get(2).x - 30, cadrados.get(2).y = cadrados.get(2).y + 30);
        cadrados.get(3).lblCadrado.setLocation(cadrados.get(3).x = cadrados.get(3).x, cadrados.get(3).y = cadrados.get(3).y + 60);
