...
public class FichaT extends Ficha {
    ...
    Cadrado cadrado0 = new Cadrado(120, 0, Color.red);
    Cadrado cadrado1 = new Cadrado(120, 30, Color.red);
    Cadrado cadrado2 = new Cadrado(120, 60, Color.red);
    Cadrado cadrado3 = new Cadrado(150, 30, Color.red);
    Border borde;
    ...
    public FichaT() {
        ...
        for (int i = 0; i < cadrados.size(); i++) {
            ...
            cadrados.get(i).lblCadrado.setBackground(Color.red);
    ...
    public boolean rotar() {
        ...
        cadrados.get(3).lblCadrado.setLocation(cadrados.get(3).x = cadrados.get(3).x - 30, cadrados.get(3).y = cadrados.get(3).y + 30);
        }else if(posicion==1){
        cadrados.get(0).lblCadrado.setLocation(cadrados.get(0).x = cadrados.get(0).x + 30, cadrados.get(0).y = cadrados.get(0).y - 30);
        cadrados.get(2).lblCadrado.setLocation(cadrados.get(2).x = cadrados.get(2).x - 30, cadrados.get(2).y = cadrados.get(2).y + 30);
        cadrados.get(3).lblCadrado.setLocation(cadrados.get(3).x = cadrados.get(3).x - 30, cadrados.get(3).y = cadrados.get(3).y - 30);    
